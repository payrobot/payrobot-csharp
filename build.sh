...
${nuget_cmd} install src/payrobot/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/payrobot.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/payrobot.dll \
-recurse:'src/payrobot/*.cs' \
-doc:bin/payrobot.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/payrobot.dll was created successfully"
fi
