...
namespace payrobot.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = payrobot.Client.Configuration.Default;
            RestClient = new RestClient("https://api.payrobot.io");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.payrobot.io).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? payrobot.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.payrobot.io")
        {
