...
namespace payrobot.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WalletCreationInfo :  IEquatable<WalletCreationInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletCreationInfo" /> class.
        /// </summary>
        /// <param name="currency">currency.</param>
        /// <param name="walletId">Unique ID of the new created Wallet.</param>
        /// <param name="walletPassphrase">Passphrase required to authorize send funds from your wallet.</param>
        /// <param name="error">&#x60;true&#x60; is there was a problem. &#x60;false&#x60; if not .</param>
        public WalletCreationInfo(CryptoCurrency? currency = default(CryptoCurrency?), string walletId = default(string), string walletPassphrase = default(string), bool error = default(bool))
        {
        ...
        /// </summary>
        /// <value>Passphrase required to authorize send funds from your wallet</value>
        [DataMember(Name="walletPassphrase", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WalletCreationInfo {\n");
            sb.Append("  Currency: ").Append(Currency).Append("\n");
            sb.Append("  WalletId: ").Append(WalletId).Append("\n");
            sb.Append("  WalletPassphrase: ").Append(WalletPassphrase).Append("\n");
        ...
        {
            return this.Equals(input as WalletCreationInfo);
        }

        /// <summary>
        /// Returns true if WalletCreationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletCreationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletCreationInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WalletPassphrase == input.WalletPassphrase ||
                    (this.WalletPassphrase != null &&
                    this.WalletPassphrase.Equals(input.WalletPassphrase))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WalletPassphrase != null)
                    hashCode = hashCode * 59 + this.WalletPassphrase.GetHashCode();
                if (this.Error != null)
