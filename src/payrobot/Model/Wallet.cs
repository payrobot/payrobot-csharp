...
namespace payrobot.Model
{
    ...
    public partial class Wallet :  IEquatable<Wallet>, IValidatableObject
    {
        ...
        /// <param name="received">Total received.</param>
        /// <param name="sent">Total sent.</param>
        /// <param name="balance">Current wallet balance.</param>
        /// <param name="error">&#x60;true&#x60; is there was a problem. &#x60;false&#x60; if not .</param>
        public Wallet(CryptoCurrency? currency = default(CryptoCurrency?), string walletId = default(string), string received = default(string), string sent = default(string), string balance = default(string), bool error = default(bool))
        {
        ...
        /// </summary>
        /// <value>Current wallet balance</value>
